...
function mapStateToProps(state) {
  return {
    allPayableList: state.counterReducer["account"],
  };
}

function mapDispatchToProps(dispatch) {
  return {
    CallGetPayableList: () => dispatch(GitAction.CallGetPayableList()),
  };
}
...
class ViewPayableComponent extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      // <div style={{ width: "100%" }}>
      //   <h1 style={{ margin: "20px" }}>Payable Suppliers</h1>
      //   <DisplayTable
      //     Data={this.props.allPayableList}
                    ...
                    <div style={{ padding: "2%" }}>
                      <MaterialTable
                        ...
                        columns={[
                          ...
                          {
                            title: "Status",
                            field: "ProductPurchaseOrderStatus",
                          },
                          {
                            title: "Date",
                            field: "CreatedDate",
