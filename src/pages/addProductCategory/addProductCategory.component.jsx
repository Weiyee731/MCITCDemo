...
function mapDispatchToProps(dispatch) {
  return {
    ...
    CallAddProductCategory: (prod) => dispatch(GitAction.CallAddProductCategory(prod)),
  };
}
...
class AddProductCategoryComponent extends Component {
  constructor(props) {
    ...
    this.addProductCategoryForm = this.addProductCategoryForm.bind(this);
  }
  ...
  handleChange(data, e) {
    ...
    if (data === "ProductCategoryName") {
      if(name !== '' || alphaNumbericRegex.test(name)){
        ...
        toast.warning( "The Product Category Name is required");
      }
  ...
  addProductCategoryForm() {
    let formData = {
      ProductCategory: this.state.ProductCategroyName,
      ProductCategoryImage: 'NULL',
      HierarchyID: this.state.HierarchyLevel,
      ParentProductCategoryID: this.state.ParentProductCategoryID,
    }
    let returnVal = this.props.CallAddProductCategory(formData);
    if(returnVal.type === 'ADD-PRODUCTCATEGORY'){
      toast.warning( "Product Category Added.");
    }
  }
  ...
  selectCategory = (elemId, elemName, elemHierarchy = 0) => {
    if (typeof elemName === "string") {
      ...
      toast.success( "You are selecting too fast! \nPlease select again.");
    }
  };
    ...
    return (
      <div className="App" style={{ width: "100%", alignContent: "center" }}>
        <div className="App-header">
          <h1 style={{ margin: "10px" }}>Product Category Detail</h1>
        </div>
        <Button onClick={back}>
          ...
          <Card style={cardStyle}>
            <CardContent>
              ...
              <TextField
                ...
                defaultValue={this.state.ProductCategroyName}
              ...
              <Button
                variant="contained"
                color="primary"
                onClick={this.addProductCategoryForm}
