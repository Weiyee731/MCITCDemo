...
function mapStateToProps(state) {
  return {
    allReceivableList: state.counterReducer["account"],
  };
}

function mapDispatchToProps(dispatch) {
  return {
    CallGetReceivableList: () => dispatch(GitAction.CallGetReceivableList()),
  };
}
...
class ViewReceivableComponent extends Component {
  constructor(props) {
    super(props);
    ...
    this.props.CallGetReceivableList();
  }

  render() {
    return (
      <div style={{ width: "100%" }}>
        <h1 style={{ margin: "20px" }}>Receivable Merchants</h1>
        <DisplayTable
          Data={this.props.allReceivableList}
