...
const DeletableTableToolbar = (props) => {
  ...
  const onEndorseSupplier = () => {
    toast.success("propsValue: " + props.length);
    props.ProductProps.callEndorseSupplier(props);
    props.ProductProps.callAllSupplierByUserStatus("Pending");
  };
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          Please select the suppliers that you want to endorse.
        </Typography>
      )}
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.UserContactNo}</TableCell>
                      <TableCell align="left">{row.CompanyName}</TableCell>
                      <TableCell align="left">{row.CompanyContactNo}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
    ...
    return (
      <div style={{ margin: "2%" }}>
        {this.state.detailsShown ? (
          ...
          <div>
            <h1>Supplier Endorsement List</h1>
            <div>
              <FormControlLabel
                control={
                  <Switch
...
class ViewSupplierEndorsementComponent extends Component {
  constructor(props) {
    super(props);
    this.props.callAllSupplierByUserStatus("pending");
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(ViewSupplierEndorsementComponent);
