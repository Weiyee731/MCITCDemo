    ...
    d.PicturePromotion = (
      <div>
        <img
          height={50}
          src={
            JSON.parse(d.PromotionImages)
              ? JSON.parse(d.PromotionImages)[0].PromotionMediaUrl
              : Logo
          }
          onError={(e) => {
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.PromotionStatus}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
          ...
          <div>
            ...
            <div>
              <Button>
                ...
                <Link className="nav-link" to={"/addPromotionBanner"}>
