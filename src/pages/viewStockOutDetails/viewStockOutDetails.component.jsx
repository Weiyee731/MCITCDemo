...
class ViewStockOutDetailsComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  onAccept = () => {
    ...
    let Product = JSON.parse(this.state.orderProductDetail);
    let selectedProduct = [];
    let selectedProductAmount = [];

    Product.map((item) => {
      selectedProduct.push(item.ProductID);
      selectedProductAmount.push(item.ProductQuantity);
    });

    this.props.CallUpdateProductStockOut({
      OrderID: this.props.data.orderID,
      ProductID: selectedProduct,
      ProductStockAmount: selectedProductAmount,
    });
  };
