...
function mapDispatchToProps(dispatch) {
  return {
    ...
    CallAddGridStorages: (prodData) =>
      dispatch(GitAction.CallAddGridStorages(prodData)),
  };
}

class AddGridStorageComponent extends Component {
  constructor(props) {
    super(props);
    ...
    this.addGridstorageForm = this.addGridstorageForm.bind(this);
  }
  ...
  addGridstorageForm() {
    ...
    this.props.CallAddGridStorages(this.state);
  }
  ...
  render() {
    ...
    const Shoplots = () => (
      <Select
        ...
        onChange={this.handleChange.bind(this, "ShoplotID")}
        inputProps={{
    ...
    return (
      <div className="App" style={{ width: "100%", alignContent: "center" }}>
        <div className="App-header">
          <h1 style={{ margin: "10px" }}>Grid Storage Detail</h1>
        </div>
        <Button onClick={back}>
