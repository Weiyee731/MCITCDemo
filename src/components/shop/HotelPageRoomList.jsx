...
function HotelPageRoomList(props) {
...
HotelPageRoomList.defaultProps = {
  layout: "standard",
  sidebarPosition: "start",
};

export default connect(mapStateToProps, mapDispatchToProps)(HotelPageRoomList);
